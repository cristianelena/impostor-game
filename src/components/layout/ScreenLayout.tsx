...
export function ScreenLayout({ children, className }: ScreenLayoutProps) {
    return (
        <div className="h-[100dvh] w-full bg-zinc-950 text-white flex flex-col relative overflow-hidden font-sans">
            {/* Background Ambience */}
            ...
            <main className={cn(
                "flex-1 flex flex-col w-full p-6 relative z-10 overflow-y-auto",
                className
            )}>
                {children}
            </main>
